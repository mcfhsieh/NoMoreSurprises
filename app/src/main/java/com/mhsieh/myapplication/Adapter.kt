...
class FoodAdapter(private val clickListener: FoodDataListener) : androidx.recyclerview.widget.ListAdapter<FoodData, FoodAdapter.FoodViewHolder>(FoodDataDiffCallback()) {
